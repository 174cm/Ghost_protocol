 ...
 * 
 * @author 주환오
 * @brief 검색한 날짜로 기본정보 6개를 출력하는 클래스
 */
public class MusicalThirdFrame extends JFrame {
	 ...
	 * @param data4
	 * @param data5
	 * @param data6   일련번호를 제외한 6개의 정보를 받아옴.
	 * @param numbers 일련번호를 받아옴
	 * @param m       연결된 클라이언트
	 */
	public MusicalThirdFrame(String data1, String data2, String data3, String data4, String data5, String data6,
		...
		Box BusanMusicalBox = Box.createHorizontalBox();
		BusanMusicalBox.setFont(new Font("함초롬돋움", Font.PLAIN, 25));
		BusanMusicalBox.setBorder(new TitledBorder(new LineBorder(new Color(149, 235, 227), 4), "부산 뮤지컬 정보",
				TitledBorder.CENTER, TitledBorder.TOP, new Font("함초롬돋움", Font.PLAIN, 25), null));
		BusanMusicalBox.setBounds(12, 44, 539, 568);
		contentPane.add(BusanMusicalBox);
	}
}
