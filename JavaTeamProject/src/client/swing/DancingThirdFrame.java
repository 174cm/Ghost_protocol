 ...
 * 
 * @author 주환오
 * @brief 검색한 날짜에따라 기본정보를 출력해주는 클래스
 *
 */
public class DancingThirdFrame extends JFrame {
	 ...
	 * @param data4
	 * @param data5
	 * @param data6   검색한 날짜에따라 일련정보를 제외한 6개의 정보를 받아온다.
	 * @param numbers 일련정보를 받는다.
	 * @param m       연결된 클라이언트.
	 */
	public DancingThirdFrame(String data1, String data2, String data3, String data4, String data5, String data6,
		...
		button1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new DancingFourthFrame(numbers[0]).setVisible(true);
			}
		});
		...
		button2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new DancingFourthFrame(numbers[1]).setVisible(true);
			}
		});
		...
		button3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new DancingFourthFrame(numbers[2]).setVisible(true);
			}
		});
		...
		button4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new DancingFourthFrame(numbers[3]).setVisible(true);
			}
		});
		...
		button5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new DancingFourthFrame(numbers[4]).setVisible(true);
			}
		});
		...
		button6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new DancingFourthFrame(numbers[5]).setVisible(true);
			}
		});
		...
		BusanExhibiBox.setBorder(new TitledBorder(new LineBorder(new Color(149, 235, 227), 4), "부산 연극/뮤지컬",
