 ...
 * 
 * @author 박성호
 * @brief 음악/무용의 정보를 알려주는 클래스
 */
public class ApiMusicDancingInfo extends ParsingMaster {
	protected String date_yyyymm;
/**
 * 
 * @param date_yyyymm 날짜를 전달
 */
	public ApiMusicDancingInfo(String date_yyyymm) {
		urlStart = "http://apis.data.go.kr/6260000/CultureInfoService/getMusicDanceList?";
		...
		try {
			...
			logger.warning("[MusicDancing error]");
		} // catch end
