 ...
 * 
 * @author 박성호
 * @brief 음악/무용의 상세 정보 클래스
 */
public class ApiMusicDancingDetail extends ParsingMaster {
	protected int data_sid;
	/**
	 * 
	 * @param data_sid 해당 게시물의 일련번호
	 */
	public ApiMusicDancingDetail(int data_sid) {
		urlStart = "http://apis.data.go.kr/6260000/CultureInfoService/getMusicDanceDetail?";
