 ...
 * 
 * @author 박성호
 * @brief 전시 정보를 알려주는 클래스 
 */
public class ApiExhibitInfo extends ParsingMaster {
	protected String date_yyyymm;
	/**
	 * 
	 * @param date_yyyymm 요구명세에서 요구하는 날짜
	 */
	public ApiExhibitInfo(String date_yyyymm) {
		urlStart = "http://apis.data.go.kr/6260000/CultureInfoService/getExhibitList?";
